...
// ---------------- PID variables ----------------
float wallKp = 2.3;   // start small
float wallKi = 0.001; // start near zero
float wallKd =8.0;    // start small
...
const int wf_clearanceThresh = 120;
...
const int wf_innerSpeed = 55;     //80 Increased minimum for better movement
